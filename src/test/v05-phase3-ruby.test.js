...
const IDS = ['RB-DESERIALIZE-001', 'RB-SECRETS-001', 'RB-SQL-RAW-001', 'RB-TLS-VERIFY-001'];
...
describe('Phase 3 (Ruby): manifest shape', () => {
  ...
  it('Ruby adapters are invisible to users (not in v0.4 PROBES, not in OWASP map)', () => {
