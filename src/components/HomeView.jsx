      ...
      {!results && (
        <div className="ap-card" style={{ padding: 24 }}>
          ...
          <div style={{ marginTop: 18, fontSize: 12, color: T.textMuted, lineHeight: 1.6 }}>
            ...
            probing, IDOR testing, or runtime authentication checks. Findings are evidence-backed
      ...
      {!results && (
        ...
        >
          ...
          <dl style={{ margin: 0, padding: 0 }}>
            {[
              {
                q: 'Does PreFlight send my source code to a server?',
              ...
              {
                q: 'Can PreFlight catch supply-chain attacks from 2025-2026?',
              ...
              {
                q: 'Does PreFlight work with apps not built by AI?',
                a: 'Yes. Most probes are framework-agnostic and apply to any JavaScript, TypeScript, Python, Go, Ruby, HTML, or SQL project. The vibe-coding framing is about who needs the help most, not about what code PreFlight is technically capable of scanning.',
              },
            ].map((item, i) => (
              <div
                key={i}
