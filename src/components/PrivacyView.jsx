...
// this page just names them in the order someone evaluating PreFlight expects
// to see them.
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 16, color: T.text, marginBottom: 24 }}>
        PreFlight is a static security audit that runs entirely in your browser tab. The privacy
      ...
      <ul style={{ paddingLeft: 22, marginBottom: 22, color: T.textDim }}>
        ...
        <li>No cookies set by PreFlight.</li>
      ...
      <p style={{ color: T.textDim, marginBottom: 12 }}>
        PreFlight uses your browser’s localStorage to remember the following between visits. It
      ...
      <p style={{ color: T.textDim, marginBottom: 12 }}>
        PreFlight ships two optional AI surfaces. Both use your own credentials and run entirely in
        your browser.
      </p>
      <ul style={{ paddingLeft: 22, marginBottom: 22, color: T.textDim }}>
        <li>
          <strong style={{ color: T.text }}>Copy Agent Prompt:</strong> formats a prompt and writes
          it to your clipboard. You paste it into whatever AI tool you already use. PreFlight does
        ...
        <li>
          ...
          (api.openai.com, api.anthropic.com, etc.). PreFlight’s origin never sees the request, the
      ...
      <p style={{ color: T.textDim, marginBottom: 22 }}>
        ...
        PreFlight’s origin never sees the URL or the source code. GitHub’s servers see the request
      ...
      <p style={{ color: T.textDim, marginBottom: 12 }}>
        PreFlight is hosted on Cloudflare Pages. At the edge, Cloudflare records standard
      ...
      <p style={{ color: T.textDim, marginBottom: 12 }}>
        Cloudflare aggregates that data into a site-metrics dashboard the PreFlight maintainers can
      ...
      <p style={{ color: T.textDim, marginBottom: 22 }}>
        PreFlight has not added any analytics JavaScript to the page. There is no Google Analytics,
        ...
        already generate. Your browser does not run any tracking code that PreFlight installed.
      </p>
      ...
      <p style={{ color: T.textDim, marginBottom: 22 }}>
        PreFlight is open source. Every change to the application, including changes to this policy,
        is publicly tracked in the git history at{' '}
        <a
      ...
      <p style={{ color: T.textDim, marginBottom: 22 }}>
        PreFlight does not collect any data about anyone, including children. We don’t target the
