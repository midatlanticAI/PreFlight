...
export function BreakersPanel({ probeName }) {
  const breakers = getBreakers(probeName);
  ...
  return (
    ...
    >
      ...
      >
        Concrete examples of what an attacker would type to exploit this finding. Static
        only. Pre-Flight does not send, run, or otherwise act on these payloads. They are
        here so you can reproduce the failure in your own dev environment and confirm the
        fix.
      </p>
