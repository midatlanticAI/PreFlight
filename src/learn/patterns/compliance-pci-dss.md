...
summary: PCI DSS v4.0 governs systems that store, process, or transmit cardholder data. A few of its requirements are visible in source code. Pre-Flight maps a subset of its probes to PCI requirements as an interpretation layer, never a certification.
---
...
Pre-Flight is in scan scope for the code-detectable PCI requirements.
...
Pre-Flight does not certify PCI compliance, complete a SAQ, or replace a
...
scoped and segmented. A Pre-Flight finding is an input to that review,
not the review itself.

## Not legal advice

This page explains how Pre-Flight relates findings to PCI DSS
